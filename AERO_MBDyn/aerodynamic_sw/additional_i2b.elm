...
joint: INT_BLADE + F_NOD, total joint,
  ...
  INT_BLADE+F_NOD,
    position, reference, INT_BLADE + C_NOD, null,
    position orientation, reference, INT_BLADE + F_NOD, eye,
    rotation orientation, reference, INT_BLADE + F_NOD, eye,
  position constraint, 1, 1, 1, null,
...
joint: CURR_BLADE + D_NOD, total joint,
  ...
  CURR_BLADE+D_NOD,
    position, reference, CURR_BLADE + C_NOD, null,
    position orientation, reference, CURR_BLADE + D_NOD, eye,
    rotation orientation, reference, CURR_BLADE + D_NOD, eye,
  position constraint, 1, 1, 1,null,
  orientation constraint, 1, 1, 0, null;
